...
$.each([
  'dialogue  show_answers//scroll       ask_a_question            view_events//scroll',
  'dream     add_action_idea//wand30    add_landmark//landmark21  edit_activities//lightbulb_icon29  identify_resource//gift23',
  'deputize  approve_deputies',
  'mobilize  assign_agents              start_something  join_something  chat//chat_icon18'
], function(){
