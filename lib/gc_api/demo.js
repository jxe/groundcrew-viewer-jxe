...
Demo = {
  ...
  yesno_answers: [
    {a: "yes", evtype: 'answered_yes'}, {a: "yes, that sounds great", evtype: 'answered_yes'},
    {a: "no", evtype: 'answered_no'}, {a: "no, sorry", evtype: 'answered_no'},
  ...
  create_rcv_event: function(atype, person, op, changes, json_etc, delay_min, delay_max) {
    ...
    setTimeout(function(){
      ...
      ev(city_id, op_id, person, now, atype, json_etc["msg"], json_etc);
    }, delay);
    return delay;
  },
  ...
  post_event: function(data) {
    return ev(This.city, data.venture, window.authority, Date.unix(), data.type, data.msg, {
      actor_title: window.user_name || 'You'
    });
  },
